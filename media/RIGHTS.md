# Demonstration media rights

Copyright (C) 2026 RR — GEL RAM Project.

The project-owned recordings, previews and extracted screenshots in this `media/` directory are covered by the root GEL RAM Noncommercial Reciprocal License 1.0 for copyright purposes.

You may view, copy, share and adapt those project-owned media files for Noncommercial Purposes, provided You preserve the applicable copyright and license notices and do not imply project endorsement.

Any Monetized Use of those media files, including paid redistribution, advertising-supported reuse, commercial promotion, paid training material, paid product bundling or other revenue-linked reuse, requires a separate written Commercial Agreement from the Project Licensor.
