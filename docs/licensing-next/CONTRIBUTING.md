# Contributing to GEL RAM after the next-license cutover
...
8. run the authoritative project verification command for the release tree.
...
Do not disclose an unpatched vulnerability in a public issue or pull request. Follow the operative `SECURITY.md` after cutover.
